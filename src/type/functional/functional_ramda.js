...
let getDataByKeys = curry(function(key) {
  return compose(R.map(R.prop(key)));
});
...
let sortByTime = curry(function(key) {
  return (a, b) => moment(a[key]) - moment(b[key]);
});
