...
let pureLog = function(x) { return new IO(function() { return 'logged ' + x }) }
...
function emailBlast(email) { return new IO(function() { return 'success add: ' + email }) }

//  validateEmail :: Email -> Either String Email
let validateEmail = function(x) { return x.match(/\S+@\S+\.\S+/) ? Right.of(x) : Left.of('invalid email') }
